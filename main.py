...
from workingWithFiles import Interaction
...
class MainApp(App):
    ...
    def game_over(self):
        self.interaction.writeNewScore(self.root.ids.score.text)
        self.root.ids.highest.text = ""
    ...
    def start_game(self):
        ...
        self.root.ids.highest.text = "Nejvyšší skore: " + self.interaction.getHighestScore()
